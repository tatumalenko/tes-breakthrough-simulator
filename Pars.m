function Sol = Pars_TES
    ...
    Sol.eb    = 0.39;       % void fraction in the column 
    ...
    Sol.T0      = 298.15;                   % K; initial temperature
    Sol.Tginlet = Sol.T0;
    Sol.Patm    = 1.1;                      % atm; operating pressure
    ...
    Sol.vg      = Sol.Vdot*4/(Sol.PI*(Sol.Dint^2)*60000); % m/s; instertial velocity 
...
%     Sol.hw      = 8.217;
    ...
    Sol.Dp   = 0.0023; % m; particle radius
    Sol.Rp   = Sol.Dp/2;
...
%     Sol.hf = 30.77;
    ...
    Sol.kw   = 17;    % W/m.K; conductivity of wall
    % Sol.Uo   = 2.365;
end