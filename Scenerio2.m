function ysol = Scenerio2(Pars,varargin)
    % ---------------------------------------------------------------------
...
%             end
            ...
            cgt(i)=... UNSURE ABOUT (1-eb) TERM!!!!
                Dz                          *cgzz(i)...         Diffusive
                -vi                         *cgz(i)...          Convective
                -rhos*(1-eb)/eb*qt(i)...                        Source
                ;

            Tgt(i)=...
                kg/eta                      *Tgzz(i)...         Diffusive
                -vg*rhog*Cpg/eta            *Tgz(i)...          Convective
                -2/Rint*hw/eta              *(Tg(i)-Tw(i))...   Source
                -rhop*abs(dHads)*qt(i)/eta...                   Source
                ;               
